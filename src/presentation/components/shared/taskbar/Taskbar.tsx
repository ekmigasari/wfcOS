...
export const Taskbar = () => {
  ...
  return (
    <div className="taskbar fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[1000] flex gap-2 p-1 rounded-lg bg-primary/80 backdrop-blur-sm border border-secondary shadow-lg">
